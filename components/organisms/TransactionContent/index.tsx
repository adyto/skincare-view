            ...
            <table className="table table-borderless">
              ...
              <tbody id="list_status_item">
                {transactions.map((transaction: HistoryTransactionTypes) => (
                  <TableRow
                    key={transaction._id}
                    image={`${IMG}/${transaction.historyVoucherPembelian.thumbnail}`}
                    title={transaction.historyVoucherPembelian.kardusName} 
                    category={transaction.historyVoucherPembelian.category} 
                    item={`${transaction.historyVoucherPembelian.nominalQuantity} ${transaction.historyVoucherPembelian.nominalName}`}
